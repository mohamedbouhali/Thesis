...
def get_args():
	...
	parser.add_argument('--learn', help='type of training method', type=str, default='normal', choices=learner_collection.keys())
	...
	parser.add_argument('--mutation_rate', help='Mutation rate ', type=np.int32, default=0.01)
	parser.add_argument('--use_curriculum', help='use curriculum learning for generating progressively dificult env', type=str2bool, default=True)
	parser.add_argument('--number_of_generations', help='how many generation should be created', type=np.int32, default=3)
	parser.add_argument('--new_mujoco_path', help='the path to the new generated env', type=str, default="0")
...
def experiment_setup_testing(args):#for test purpose
	for _ in range(250):
		env = make_env(args)
		env.reset()
		env.render()
